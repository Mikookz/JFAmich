...
class ColorConstant {
  ...
  static Color black90001 = fromHex('#FF111238');

  static Color gray3008d = fromHex('#8ddedede');

  static Color black90000 = fromHex('#001b1201');

  static Color amberA700 = fromHex('#FF91eb8e');
  ...
  static Color black9000001 = fromHex('#00010f13');
  ...
  static Color amber300 = fromHex('#FF6df243');
  ...
  static Color blue400 = fromHex('#FF029597');
