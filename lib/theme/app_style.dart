...
class AppStyle {
  static TextStyle txtPoppinsLight8 = TextStyle(
  ...
  static TextStyle txtPoppinsMedium12Bluegray10001 = TextStyle(
  ...
  static TextStyle txtPoppinsMedium12WhiteA700 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      12,
    ),
  ...
  static TextStyle txtPoppinsMedium14Gray500ab = TextStyle(
  ...
  static TextStyle txtPoppinsMedium14WhiteA70087 = TextStyle(
  ...
  static TextStyle txtPoppinsRegular14Bluegray100a2 = TextStyle(
    color: ColorConstant.blueGray100A2,
    fontSize: getFontSize(
      14,
    ),
    fontFamily: 'Poppins',
  ...
  static TextStyle txtPoppinsRegular12Bluegray30001 = TextStyle(
  ...
  static TextStyle txtPoppinsRegular12Bluegray100a2 = TextStyle(
    color: ColorConstant.blueGray100A2,
    fontSize: getFontSize(
      12,
    ),
  ...
  static TextStyle txtPoppinsRegular12WhiteA70099 = TextStyle(
  ...
  static TextStyle txtPoppinsSemiBold26 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      26,
    ),
  ...
  static TextStyle txtPoppinsMedium18WhiteA700ab = TextStyle(
  ...
  static TextStyle txtPoppinsRegular10Gray400 = TextStyle(
  ...
  static TextStyle txtPoppinsRegular10Bluegray300 = TextStyle(
    color: ColorConstant.blueGray300,
    fontSize: getFontSize(
      10,
    ),
  ...
  static TextStyle txtPoppinsRegular12Bluegray10001 = TextStyle(
    color: ColorConstant.blueGray10001,
    fontSize: getFontSize(
      12,
    ),
  ...
  static TextStyle txtPoppinsRegular10Bluegray400 = TextStyle(
    color: ColorConstant.blueGray400,
    fontSize: getFontSize(
      10,
    ),
  ...
  static TextStyle txtPoppinsRegular12Bluegray10002 = TextStyle(
  ...
  static TextStyle txtPoppinsRegular12WhiteA700a2 = TextStyle(
    color: ColorConstant.whiteA700A2,
    fontSize: getFontSize(
      12,
    ),
  ...
  static TextStyle txtPoppinsRegular10Indigo50 = TextStyle(
  ...
  static TextStyle txtPoppinsMedium14Red700 = TextStyle(
  ...
  static TextStyle txtPoppinsRegular10Bluegray10003 = TextStyle(
