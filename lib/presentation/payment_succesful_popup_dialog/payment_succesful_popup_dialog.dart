import 'bloc/payment_succesful_popup_bloc.dart';
import 'models/payment_succesful_popup_model.dart';
...
class PaymentSuccesfulPopupDialog extends StatelessWidget {
  static Widget builder(BuildContext context) {
    return BlocProvider<PaymentSuccesfulPopupBloc>(
      create: (context) => PaymentSuccesfulPopupBloc(PaymentSuccesfulPopupState(
        paymentSuccesfulPopupModelObj: PaymentSuccesfulPopupModel(),
      ))
        ..add(PaymentSuccesfulPopupInitialEvent()),
      child: PaymentSuccesfulPopupDialog(),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          BlocSelector<PaymentSuccesfulPopupBloc, PaymentSuccesfulPopupState,
              bool?>(
            selector: (state) => state.isCheckbox,
            builder: (context, isCheckbox) {
              return CustomCheckbox(
                text: "msg_active_on_20_fe".tr,
                value: isCheckbox,
                margin: getMargin(
                  top: 36,
                  right: 66,
                ...
                onChange: (value) {
                  context
                      .read<PaymentSuccesfulPopupBloc>()
